  ...
  return (
    <div className="mt-2 h-screen flex items-center m-0 p-0 justify-center bg-[url('https://img.freepik.com/free-photo/ingredients-homemade-tarte-tatin-pie-with-apples-nuts-beige-background-french-apple-pie-selective-focus_127032-2805.jpg?w=2000')]">
      ...
      <div className="max-w-lg px-6 text-center text-white">
        ...
        <p className="text-xl mb-8 text-orange-700">Explore and discover delicious recipes!</p>
        <button className="bg-white text-orange-700 py-3 px-6 rounded-lg font-semibold hover:bg-indigo-100 hover:text-indigo-600 transition duration-300">
          Get Started
        </button>
      </div>
    </div>
