...
export default function Ingredients({ recipe, setSteps, steps, ingredients, recipeIngredients, units, setRecipeIngredients }) {
            ...
            if (key === recipe) {
              return (
                <Ingredient
                  ...
                  ingredient={{
                    ...ingredients[key],
                    unit: units[recipeIngredients[key].unit].UnitName,
                    amount: recipeIngredients[key].amount,
                  }}
                />
              );
            }
